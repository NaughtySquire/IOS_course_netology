...
// Решение задачи №1:
func appendToArray(array: inout [String], newElement: String) -> Void{
    array.append(newElement)
}

func removeFromArray(array: inout [String], arrayElement: String) -> Void{
    if(!array.isEmpty){
        if let indexElement = array.firstIndex(of: arrayElement){
            array.remove(at: indexElement)
        }else{
            print("Элемент \(arrayElement) не найден.")
        }
    }else{
        print("Массив пустой. В нем нечего удалять.")
    }

}

var beers: [String] = []
appendToArray(array: &beers, newElement: "Stout")
appendToArray(array: &beers, newElement: "Ale")
appendToArray(array: &beers, newElement: "Sour")
appendToArray(array: &beers, newElement: "IPA")
print(beers)
removeFromArray(array: &beers, arrayElement: "Ale")
removeFromArray(array: &beers, arrayElement: "Светлое")
removeFromArray(array: &beers, arrayElement: "Sour")
print(beers)
removeFromArray(array: &beers, arrayElement: "IPA")
removeFromArray(array: &beers, arrayElement: "Stout")
removeFromArray(array: &beers, arrayElement: "Stout")
...
func calculateSumEvenOddValues(from array: [Int?]) -> (Int, Int) {
    ...
    return (evenSet.reduce(0, +), oddSet.reduce(0, +))
}
